  ...
  <Tabs.Root className="TabsRoot" defaultValue="tab1">
    ...
    <Tabs.Content className="TabsContent" value="tab1">
      ...
      <p className="Text">
        ...
        through multiple-choice quizzes. We cover a varity of categories to keep
        ...
        smarts with questions spaning history, culturem geography, and more.
        Science & Nature - Dive into the wonders of the natural world and the
        mysteries of the universe.
      </p>
      <p>
        {" "}
        Each Quiz is timed, encourgaing quick thinking under pressure. Can you
        beat the clock and claim the top spot on our leaderboard?
      </p>
